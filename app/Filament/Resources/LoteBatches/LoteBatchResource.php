...
class LoteBatchResource extends Resource
{
    ...
    protected static ?string $navigationLabel = 'Consultar Lote';
    
    protected static ?string $modelLabel = 'Consultar Lote';
    
    protected static ?string $pluralModelLabel = 'Consultar Lote';
